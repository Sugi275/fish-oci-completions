...
# main command
complete -c oci -f -n '__fish_using_command oci' -a 'analytics announce api-gateway application-migration audit autoscaling bds blockchain budgets bv ce cloud-guard compute compute-management data-catalog data-flow data-integration data-safe data-science db dns dts email events fn fs health-checks iam integration kms lb limits log-analytics logging logging-ingestion logging-search management-agent management-dashboard marketplace monitoring mysql network nosql oce ocvs oda ons os os-management raw-request resource-manager sch search secrets session setup streaming support usage-api vault waas work-requests'
...
complete -c oci -f -n '__fish_seen_subcommand_from bds;and __fish_using_command oci bds instance' -a 'change-compartment change-shape create delete get list remove restart-node update worker-nodes'
...
# cloud-guard
complete -c oci -f -n '__fish_using_command oci cloud-guard' -a 'activity-problem-aggregation condition-metadata-type configuration detector detector-recipe detector-recipe-detector-rule detector-rule impacted-resource-summary managed-list managed-list-type-summary problem problem-aggregation problem-trend-aggregation recommendation-summary resource-type-summary responder-activity-summary responder-execution responder-execution-aggregation responder-execution-summary responder-execution-trend-aggregation responder-recipe responder-recipe-responder-rule responder-rule risk-score-aggregation security-score-aggregation security-score-trend-aggregation target target-detector-recipe target-detector-recipe-detector-rule target-responder-recipe target-responder-recipe-responder-rule'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard activity-problem-aggregation' -a 'request-summarized-activity-problems'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard condition-metadata-type' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard configuration' -a 'get update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard detector' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard detector-recipe' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard detector-recipe-detector-rule' -a 'get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard detector-rule' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard impacted-resource-summary' -a 'list-impacted-resources'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard managed-list' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard managed-list-type-summary' -a 'list-managed-list-types'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard problem' -a 'get list list-problem-histories trigger-responder update-bulk-problem-status update-problem-status'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard problem-aggregation' -a 'request-summarized-problems'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard problem-trend-aggregation' -a 'request-summarized-trend-problems'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard recommendation-summary' -a 'list-recommendations'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard resource-type-summary' -a 'list-resource-types'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-activity-summary' -a 'list-responder-activities'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-execution' -a 'execute get skip skip-bulk'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-execution-aggregation' -a 'request-summarized-responder-executions'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-execution-summary' -a 'list-responder-executions'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-execution-trend-aggregation' -a 'request-summarized-trend-responder-executions'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-recipe' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-recipe-responder-rule' -a 'get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard responder-rule' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard risk-score-aggregation' -a 'request-risk-scores request-summarized-risk-scores'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard security-score-aggregation' -a 'request-security-scores request-summarized-security-scores'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard security-score-trend-aggregation' -a 'request-security-score-summarized-trend request-summarized-trend-security-scores'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard target' -a 'create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard target-detector-recipe' -a 'create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard target-detector-recipe-detector-rule' -a 'get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard target-responder-recipe' -a 'create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from cloud-guard;and __fish_using_command oci cloud-guard target-responder-recipe-responder-rule' -a 'get list update'

# compute
complete -c oci -f -n '__fish_using_command oci compute' -a 'boot-volume-attachment console-history dedicated-vm-host dedicated-vm-host-instance device global-image-capability-schema global-image-capability-schema-version image image-capability-schema image-shape-compatibility-entry instance instance-console-connection pic shape vnic-attachment volume-attachment'
...
complete -c oci -f -n '__fish_seen_subcommand_from compute;and __fish_using_command oci compute global-image-capability-schema' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from compute;and __fish_using_command oci compute global-image-capability-schema-version' -a 'get list'
...
complete -c oci -f -n '__fish_seen_subcommand_from compute;and __fish_using_command oci compute image-capability-schema' -a 'change-compartment create delete get list update'
...
# data-flow
complete -c oci -f -n '__fish_using_command oci data-flow' -a 'application private-endpoint run work-request work-request-error work-request-log'
...
complete -c oci -f -n '__fish_seen_subcommand_from data-flow;and __fish_using_command oci data-flow private-endpoint' -a 'change-compartment create delete get list update'
...
complete -c oci -f -n '__fish_seen_subcommand_from data-flow;and __fish_using_command oci data-flow work-request' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from data-flow;and __fish_using_command oci data-flow work-request-error' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from data-flow;and __fish_using_command oci data-flow work-request-log' -a 'list'
...
complete -c oci -f -n '__fish_seen_subcommand_from db;and __fish_using_command oci db autonomous-database' -a 'change-compartment create create-from-backup-id create-from-backup-timestamp create-from-clone create-refreshable-clone data-safe delete fail-over generate-wallet get list list-clones manual-refresh restart restore start stop switchover update'
...
complete -c oci -f -n '__fish_seen_subcommand_from db;and __fish_using_command oci db autonomous-patch' -a 'get list-container-database-patches'
...
complete -c oci -f -n '__fish_seen_subcommand_from db;and __fish_using_command oci db data-guard-association create' -a 'from-existing-db-system from-existing-vm-cluster with-new-db-system'
...
complete -c oci -f -n '__fish_seen_subcommand_from db;and __fish_using_command oci db database-software-image' -a 'change-compartment create delete get list update'
...
complete -c oci -f -n '__fish_seen_subcommand_from db;and __fish_using_command oci db system' -a 'change-compartment get get-exadata-iorm-config launch launch-from-backup launch-from-db-system list patch terminate update update-exadata-iorm-config'
...
complete -c oci -f -n '__fish_seen_subcommand_from iam;and __fish_using_command oci iam tenancy' -a 'get'
...
# lb
complete -c oci -f -n '__fish_using_command oci lb' -a 'backend backend-health backend-set backend-set-health certificate health-checker hostname listener listener-rule load-balancer load-balancer-health nsg path-route-set policy protocol rule-set shape ssl-cipher-suite work-request'
...
complete -c oci -f -n '__fish_seen_subcommand_from lb;and __fish_using_command oci lb load-balancer' -a 'change-compartment create delete get list update update-load-balancer-shape'
...
complete -c oci -f -n '__fish_seen_subcommand_from lb;and __fish_using_command oci lb ssl-cipher-suite' -a 'create delete get list update'
...
# log-analytics
complete -c oci -f -n '__fish_using_command oci log-analytics' -a 'assoc assoc-collection assoc-delete assoc-entities assoc-params assoc-summary char-encoding-collection config-work-request config-work-request-collection content-export content-import entity entity-type estimate-purge-data-size-result extfields-validation field label log-group lookup namespace object-collection-rule parser query query-work-request scheduled-task source storage storage-usage storage-work-request success timezone-collection upload work-request work-request-error work-request-log'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc' -a 'upsert-assocs'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc-collection' -a 'list-entity-source-assocs list-source-assocs'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc-delete' -a 'delete-assocs'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc-entities' -a 'list-associated-entities'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc-params' -a 'validate-assoc-params'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics assoc-summary' -a 'get-assoc-summary'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics char-encoding-collection' -a 'list-supported-encodings'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics config-work-request' -a 'get-config-work-request'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics config-work-request-collection' -a 'list-config-work-requests'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics content-export' -a 'export-custom-content'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics content-import' -a 'import-custom-content'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics entity' -a 'add-associations change-compartment create delete get list list-associations remove-associations summary update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics entity-type' -a 'create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics estimate-purge-data-size-result' -a 'estimate-purge-data-size'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics extfields-validation' -a 'validate-source-extfield-details'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics field' -a 'delete-field get-field get-fields-summary list-fields upsert-field'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics label' -a 'batch-get-basic-info delete-label get-label get-label-summary list-label-priorities list-label-source-details list-labels upsert-label'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics log-group' -a 'change-compartment create delete get get-log-analytics-log-groups-summary list update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics lookup' -a 'register-lookup'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics namespace' -a 'get list offboard onboard'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics object-collection-rule' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics parser' -a 'delete-parser extract-structured-log-field-paths extract-structured-log-header-paths get-parser get-parser-summary list-parser-functions list-parser-meta-plugins list-parsers test-parser upsert-parser'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics query' -a 'export filter get-query-result parse search suggest'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics query-work-request' -a 'background cancel get list'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics scheduled-task' -a 'change-compartment clean create-acceleration-task create-standard-task delete get list run update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics source' -a 'delete-source get-column-names get-source get-source-summary list-meta-source-types list-source-extfield-defs list-source-functions list-source-label-operators list-source-patterns list-sources upsert-source validate-source'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics storage' -a 'get update'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics storage-usage' -a 'get'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics storage-work-request' -a 'get list purge-storage-data recall-archived-data release-recalled-data'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics success' -a 'disable-archiving enable-archiving'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics timezone-collection' -a 'list-supported-timezones'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics upload' -a 'delete delete-upload-file delete-upload-warning get list list-upload-files list-upload-warnings upload-log-file validate-file validate-source-mapping'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics work-request' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics work-request-error' -a 'list list-storage'
complete -c oci -f -n '__fish_seen_subcommand_from log-analytics;and __fish_using_command oci log-analytics work-request-log' -a 'list'

# logging
complete -c oci -f -n '__fish_using_command oci logging' -a 'agent-configuration log log-group log-included-search log-saved-search service work-request work-request-error work-request-log'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging agent-configuration' -a 'change-compartment create create-log-configuration delete get list update update-log-configuration'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging log' -a 'change-log-group create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging log-group' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging log-included-search' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging log-saved-search' -a 'change-compartment create delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging service' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging work-request' -a 'delete get list'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging work-request-error' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from logging;and __fish_using_command oci logging work-request-log' -a 'list'

# logging-ingestion
complete -c oci -f -n '__fish_using_command oci logging-ingestion' -a 'put-logs'

# logging-search
complete -c oci -f -n '__fish_using_command oci logging-search' -a 'search-logs'

# management-agent
complete -c oci -f -n '__fish_using_command oci management-agent' -a 'agent agent-image install-key plugin work-request work-request-error work-request-log-entry'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent agent' -a 'delete deploy-plugins get list update'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent agent-image' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent install-key' -a 'create delete get get-install-key-content list update'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent plugin' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent work-request' -a 'delete get list'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent work-request-error' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from management-agent;and __fish_using_command oci management-agent work-request-log-entry' -a 'list-work-request-logs'

# management-dashboard
complete -c oci -f -n '__fish_using_command oci management-dashboard' -a 'dashboard saved-search'
complete -c oci -f -n '__fish_seen_subcommand_from management-dashboard;and __fish_using_command oci management-dashboard dashboard' -a 'change-compartment create delete export get import list update'
complete -c oci -f -n '__fish_seen_subcommand_from management-dashboard;and __fish_using_command oci management-dashboard saved-search' -a 'change-compartment create delete get list update'
...
complete -c oci -f -n '__fish_seen_subcommand_from resource-manager;and __fish_using_command oci resource-manager stack' -a 'change-compartment create create-from-compartment create-from-git-provider delete detect-drift get get-stack-tf-config get-stack-tf-state list list-resource-discovery-services list-resource-drift-details list-terraform-versions update update-from-git-provider'
...
# sch
complete -c oci -f -n '__fish_using_command oci sch' -a 'service-connector work-request work-request-error work-request-log-entry'
complete -c oci -f -n '__fish_seen_subcommand_from sch;and __fish_using_command oci sch service-connector' -a 'activate change-compartment create deactivate delete get list update'
complete -c oci -f -n '__fish_seen_subcommand_from sch;and __fish_using_command oci sch work-request' -a 'get list'
complete -c oci -f -n '__fish_seen_subcommand_from sch;and __fish_using_command oci sch work-request-error' -a 'list'
complete -c oci -f -n '__fish_seen_subcommand_from sch;and __fish_using_command oci sch work-request-log-entry' -a 'list-work-request-logs'
